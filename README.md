...
- **Security**: Password Hashing (bcrypt) + Stateless Session
...
> **Vendor Dashboard مطلوب**: يشمل إحصائيات، طلبات واردة، عروض، شحن، وأرباح.
...
#### مواصفات الطلب (Order Specs)
- **نظام العروض (Bidding)**: العميل ينشئ طلب ← المتاجر تقدم عروض ← العميل يختار.
- **التجميع**: يدعم شحن مجمع (Combined) أو منفصل (Separate).
- **الصلاحية**: 24 ساعة لتقديم العروض قبل انتهاء الصلاحية.
- **العمولة**: 20% من قيمة كل طلب للمنصة.
...
#### الإعدادات المالية
- **بوابة الدفع**: Stripe (Auth & Capture).
...
- **الأتمتة**: إلغاء الطلبات غير المدفوعة (24 ساعة)، تصعيد النزاعات.
- **الإعدادات**: نسبة العمولة (20%)، صلاحيات الأدوار.
